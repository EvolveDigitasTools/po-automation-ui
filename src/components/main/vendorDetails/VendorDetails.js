                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <Box>
                                 ...
                                 <Button variant="contained" className="full-width-button" color="primary" type="GST Attachment">GST Attachment</Button>
                            </Box>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            />
                                 ...
                                 <Button variant="contained" className="full-width-button" color="primary" type="Bank Proof">Bank Proof</Button>
                ...
                <div className="other-details">
                    ...
                    <div className="row">
                        ...
                        <div className="col" style={{marginTop : '-5px!important'}}>
                                 ...
                                 <Button variant="contained" className="full-width-button"  color="primary" type="MSME ">MSME</Button>


                            
                                 <Button variant="contained" className="full-width-button" color="primary" type="COI ">COI</Button>

                           
                                 <Button variant="contained" className="full-width-button" color="primary" type="Trade ">Trade</Button>

                       
                                 <Button variant="contained" className="full-width-button" color="primary" type="agreement ">Agreement</Button>
